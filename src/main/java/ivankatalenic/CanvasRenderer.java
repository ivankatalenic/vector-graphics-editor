...
public class CanvasRenderer extends Canvas implements Renderer, DocumentModelListener {

	private final Color backgroundFill = Color.WHITE;
	private GUI gui;

	public CanvasRenderer(GUI gui, double width, double height) {
		super(width, height);
		this.gui = gui;
	...
	public void documentChange() {
		...
		for (GraphicalObject obj : gui.dm.list()) {
			obj.render(this);
			gui.currentState.afterDraw(this, obj);
		}
		gui.currentState.afterDraw(this);
	}
